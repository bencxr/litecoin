...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GarlicCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"garliccointools.com", "dnsseed.garliccointools.com"},
    {"garliccoinpool.org", "dnsseed.garliccoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"garliccointools.com", "testnet-seed.garliccointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GarlicCoin is probably already running."), addrBind.ToString().c_str());
        else
